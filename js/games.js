 ...
 * Обложки подставляются автоматически из assets/games/
 * Имя файла ≈ название игры (регистр/пробелы/-/_ не важны):
 *   Beat Saber  →  beat saber.png  /  beat-saber.jpg
 * Поле image можно оставить "" — путь писать вручную не нужно.
 * Если файл не найден — показывается fallback с названием.
 */
window.ZAGA_GAMES = [
  {
    name: "Beat Saber",
